$(function(e) {
	$('header').append(`
		...
		<a href="tugas-form-sederhana-[231011700483].html" class="link_menu">
		<div class="content_link">
		Newslatter
		<i class="fas fa-arrow-right responsive"></i>
		</div>
		</a>
		<a href="tugas-checkbox-radio-[231011700483].html" class="link_menu">
		<div class="content_link">
		Survey
		<i class="fas fa-arrow-right responsive"></i>
		</div>
		</a>
		<a href="tugas-dropdown-textarea-[231011700483].html" class="link_menu">
		<div class="content_link">
		Feedback
		<i class="fas fa-arrow-right responsive"></i>
		</div>
		...
		<a href="tugas-registrasi-validasi-[231011700483].html" class="box_profile">
